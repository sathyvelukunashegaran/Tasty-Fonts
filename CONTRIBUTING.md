...
See [Local Setup](docs/developer/local-setup.md) for examples, manual install notes, and common local-environment pitfalls.
...
- [Translations](docs/developer/translations.md)
