...
final class SettingsSaveFields
{
    ...
    public static function definitions(): array
    {
        return [
            ...
            ['name' => 'fallback_heading', 'kind' => 'text'],
            ['name' => 'fallback_body', 'kind' => 'text'],
            ['name' => 'fallback_monospace', 'kind' => 'text'],
            ...
            ['name' => 'extended_variable_role_alias_interface_enabled', 'kind' => 'toggle'],
            ['name' => 'extended_variable_role_alias_ui_enabled', 'kind' => 'toggle'],
            ['name' => 'extended_variable_role_alias_code_enabled', 'kind' => 'toggle'],
            ...
            ['name' => 'etch_quick_roles_panel_enabled', 'kind' => 'toggle'],
