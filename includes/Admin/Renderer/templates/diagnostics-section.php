                    ...
                    $developerToolGroups = [
                        ...
                        [
                            ...
                            'actions' => [
                                ...
                                [
									'slug' => 'reset_family_fallbacks_to_global',
									'title' => __('Delete all custom fallbacks', 'tasty-fonts'),
									'description' => __('Clears every per-family fallback override so imported fonts resolve through the global fallback settings.', 'tasty-fonts'),
									'nonce' => 'tasty_fonts_reset_family_fallbacks_to_global',
									'action_name' => 'tasty_fonts_reset_family_fallbacks_to_global',
									'button_label' => __('Delete All Custom Fallbacks', 'tasty-fonts'),
									'button_class' => 'button button-secondary tasty-fonts-button-danger tasty-fonts-advanced-row-action tasty-fonts-advanced-row-action--reset tasty-fonts-developer-action-button',
									'card_class' => 'tasty-fonts-developer-tool-card--danger',
									'confirm_message' => __('Delete all per-family fallback overrides and use global fallback settings instead?', 'tasty-fonts'),
								],
								[
									'slug' => 'reset_fallbacks_to_plugin_defaults',
									'title' => __('Reset fallback defaults', 'tasty-fonts'),
									'description' => __('Restores the global heading, body, and monospace fallback stacks to plugin defaults and clears per-family overrides.', 'tasty-fonts'),
									'nonce' => 'tasty_fonts_reset_fallbacks_to_plugin_defaults',
									'action_name' => 'tasty_fonts_reset_fallbacks_to_plugin_defaults',
									'button_label' => __('Reset Fallback Defaults', 'tasty-fonts'),
									'button_class' => 'button button-secondary tasty-fonts-button-danger tasty-fonts-advanced-row-action tasty-fonts-advanced-row-action--reset tasty-fonts-developer-action-button',
									'card_class' => 'tasty-fonts-developer-tool-card--danger',
									'confirm_message' => __('Restore plugin fallback defaults and delete all per-family fallback overrides?', 'tasty-fonts'),
								],
								[
