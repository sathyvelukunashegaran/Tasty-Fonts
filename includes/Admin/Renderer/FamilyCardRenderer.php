...
final class FamilyCardRenderer extends AbstractSectionRenderer
{
    ...
    private function buildFamilyTemplateView(
        ...
        return [
            'family' => $family,
            'roles' => $roles,
            'familyFallbacks' => $familyFallbacks,
            'familyFontDisplays' => $familyFontDisplays,
            'familyFontDisplayOptions' => $familyFontDisplayOptions,
            'previewText' => $previewText,
            'categoryAliasOwners' => $categoryAliasOwners,
            'extendedVariableOptions' => $extendedVariableOptions,
            'monospaceRoleEnabled' => $monospaceRoleEnabled,
            'classOutputOptions' => $classOutputOptions,
            'roleUsageRoles' => $roleUsageRoles,
            ...
            'isLiveHeading' => $isLiveHeading,
            'isLiveBody' => $isLiveBody,
            'isLiveMonospace' => $isLiveMonospace,
            'fontCategory' => $fontCategory,
            'assignedRoleKeys' => $assignedRoleKeys,
            'liveRoleKeys' => $liveRoleKeys,
            'isRoleFamily' => $isRoleFamily,
            'isDraftRoleFamily' => $isDraftRoleFamily,
            'fontTypeDescriptor' => $fontTypeDescriptor,
            'sourceTokens' => $sourceTokens,
            'categoryTokens' => $categoryTokens,
            'usesMonospacePreview' => $usesMonospacePreview,
            'fontCategoryLabel' => $fontCategoryLabel,
            'deleteBlockedMessage' => $deleteBlockedMessage,
            'deleteBlockedMessages' => $deleteBlockedMessages,
            'savedFallback' => $savedFallback,
            'savedFontDisplay' => $savedFontDisplay,
            'currentFontDisplay' => $currentFontDisplay,
            ...
            'supportsFontDisplayOverride' => $supportsFontDisplayOverride,
            'defaultStack' => $defaultStack,
            'fallbackSettings' => $fallbackSettings,
            'roleStacks' => $roleStacks,
            'previewLabel' => $previewLabel,
            'inlinePreviewText' => $inlinePreviewText,
            'facePreviewText' => $facePreviewText,
            'familyFaces' => $familyFaces,
            'faceSummaryLabels' => $faceSummaryLabels,
            'axisSummaryLabels' => $axisSummaryLabels,
            'visibleFaceSummaryLabels' => $visibleFaceSummaryLabels,
            'hiddenFaceSummaryCount' => $hiddenFaceSummaryCount,
            'faceCount' => $faceCount,
            'activeFaces' => $activeFaces,
            'familyCssVariableSnippets' => $familyCssVariableSnippets,
            'familyCssClassSnippets' => $familyCssClassSnippets,
            'canChangePublishState' => $canChangePublishState,
            'quickPublishAction' => $quickPublishAction,
            'quickDeliveryAction' => $quickDeliveryAction,
