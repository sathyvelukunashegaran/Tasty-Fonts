...
final class AdminPageViewBuilder
{
     ...
     */
    public function build(array $context): AdminPageViewVariables
    {
        ...
        return new AdminPageViewVariables(
            $storage,
            $currentPage,
            $pageUrls,
            $catalog,
            ...
            $googleApiEnabled,
            $googleApiSaved,
            $googleAccessExpanded,
            $adobeProjectState,
            $googleStatusLabel,
            $googleStatusClass,
            $googleAccessCopy,
            $googleSearchDisabledCopy,
            $adobeProjectEnabled,
            $adobeProjectSaved,
            $adobeAccessExpanded,
            $adobeProjectId,
            ...
            $adobeAccessCopy,
            $adobeProjectLink,
            $adobeDetectedFamilies,
            $googleAccessButtonLabel,
            $adobeAccessButtonLabel,
            $cssDeliveryMode,
            $cssDeliveryModeOptions,
            $fontDisplay,
            $fontDisplayOptions,
            $unicodeRangeMode,
            $unicodeRangeCustomValue,
            $fallbackHeading,
            $fallbackBody,
            $fallbackMonospace,
            $globalFallbackSettings,
            $unicodeRangeModeOptions,
            $unicodeRangeCustomVisible,
            $outputQuickModePreference,
            $classOutputEnabled,
            $classOutputRoleHeadingEnabled,
            $classOutputRoleBodyEnabled,
            $classOutputRoleMonospaceEnabled,
            $classOutputRoleAliasInterfaceEnabled,
            $classOutputRoleAliasUiEnabled,
            $classOutputRoleAliasCodeEnabled,
            $classOutputCategorySansEnabled,
            $classOutputCategorySerifEnabled,
            $classOutputCategoryMonoEnabled,
            $classOutputFamiliesEnabled,
            $classOutputRoleStylesEnabled,
            $minifyCssOutput,
            $roleUsageFontWeightEnabled,
            $perVariantFontVariablesEnabled,
            $minimalOutputPresetEnabled,
            $extendedVariableRoleWeightVarsEnabled,
            $extendedVariableWeightTokensEnabled,
            $extendedVariableRoleAliasesEnabled,
            $extendedVariableRoleAliasInterfaceEnabled,
            $extendedVariableRoleAliasUiEnabled,
            $extendedVariableRoleAliasCodeEnabled,
            $extendedVariableCategorySansEnabled,
            $extendedVariableCategorySerifEnabled,
            $extendedVariableCategoryMonoEnabled,
            $preloadPrimaryFonts,
            $remoteConnectionHints,
            $updateChannel,
            $updateChannelOptions,
            $updateChannelStatus,
            $adminAccessCustomEnabled,
            $adminAccessRoleSlugs,
            $adminAccessRoleOptions,
            $adminAccessUserIds,
            $adminAccessUserOptions,
            $adminAccessSummary,
            $developerToolStatuses,
            $blockEditorFontLibrarySyncEnabled,
            $showActivityLog,
            $trainingWheelsOff,
            $variableFontsEnabled,
            $googleFontImportsEnabled,
            $bunnyFontImportsEnabled,
            $adobeFontImportsEnabled,
            $localFontUploadsEnabled,
            $customCssUrlImportsAvailable,
            $customCssUrlImportsEnabled,
            $customCssUrlImportsExperimentalHelp,
            $deleteUploadedFilesOnUninstall,
            $advancedTools,
            $diagnosticItems,
            $overviewMetrics,
            $outputPanels,
            $outputTogglePreviews,
            $generatedCssPanel,
            $previewPanels,
            ...
            $previewRoles,
            $hasPendingLiveRoleChanges,
            $previewHasDraftRoleChanges,
            $previewHasPendingLiveRoleChanges,
            ...
            $previewHeadingStack,
            $previewBodyStack,
            $previewMonospaceStack,
            $saveDraftDisabledCopy,
            $applyLiveDisabledCopy,
            $headingFamily,
            $bodyFamily,
            $monospaceFamily,
            $headingFallback,
            ...
            $bodyVariable,
            $monospaceVariable,
            $headingFamilyVariable,
            $bodyFamilyVariable,
            $monospaceFamilyVariable,
            $pluginVersion,
            $pluginRepositoryUrl,
            $pluginVersionUrl,
            $pluginVersionChannelLabel,
            $pluginVersionStateLabel,
            $pluginVersionMeta,
            $pluginVersionBadgeClass,
            $pluginVersionTooltip,
            $pluginVersionAriaLabel,
            $roleDeploymentBadge,
            $roleDeploymentBadgeClass,
            $roleDeploymentTitle,
            $roleDeploymentCopy,
            $roleDeploymentTooltip,
            $roleDeploymentAnnouncementId,
            $storageErrorMessage,
            $categoryAliasOwners,
            $bodyFamilyAssigned,
            $monospaceFamilyAssigned,
            $outputDependencyStates,
            $extendedVariableOptions,
            $classOutputOptions,
            $outputQuickMode,
            $advancedOutputControlsExpanded
        );
    }
